...
function MovieCard({
  ...
  return (
    <button
      ...
      className={`flex flex-col text-left rounded-2xl border transition-all duration-250 select-none relative outline-none overflow-hidden ${
  item.type === 'live' ? 'h-[340px]' : 'h-[300px]'
} shrink-0 ${
        isGridFocused
    ...
    >
      ...
      <div
        className={`${
  item.type === 'live' ? 'h-56' : 'h-44'
} relative overflow-hidden flex items-center justify-center shrink-0 transition-all duration-300 ${
          isGridFocused
